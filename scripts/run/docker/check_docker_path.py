...
#     """
#     Checks if Docker is installed and finds its executable path.

#     Returns:
#         - str: Full path to the Docker executable if found.
#         - None: If Docker is not found.
#     """
#     # Try to locate docker using shutil (cross-platform)
#     docker_path = shutil.which("docker")
	
#     if docker_path:
#         return docker_path  # Docker found
